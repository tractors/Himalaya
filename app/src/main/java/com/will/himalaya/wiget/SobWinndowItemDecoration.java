...
public class SobWinndowItemDecoration extends RecyclerView.ItemDecoration {
    private int mColor;
    private int left;
    private int right;
    private int top;
    ...
    public SobWinndowItemDecoration(int leftRight,int topBottom,@ColorInt int color){
        this.mColor = color;
        this.left = leftRight;
    ...
    public SobWinndowItemDecoration(int boundLeft,int boundRight,int topBottom,@ColorInt int color){
        this.mColor = color;
        this.left = 0;
        this.right = 0;
        this.top = topBottom;
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (layoutManager.getOrientation() == GridLayoutManager.VERTICAL) {
            for (int i = 0; i < childCount - 1; i++) {
                ...
                mDivider.setBounds(left+ UIUtil.dip2px(parent.getContext(),boundLeft), top, right-UIUtil.dip2px(parent.getContext(),boundRight), bottom);
                mDivider.draw(c);
            }
        }
    }
